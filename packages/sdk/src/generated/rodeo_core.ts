...
export const rodeoCoreIdl = {
  ...
  "instructions": [
    ...
    {
      "name": "append_transfer_bull_proof",
      "discriminator": [
        52,
        74,
        65,
        ...
        },
        {
          ...
          "pda": {
            "seeds": [
              ...
              {
                "kind": "account",
                "path": "bull_proof_buffer.position",
                "account": "BullProofBuffer"
              },
              {
                "kind": "account",
        ...
        },
        {
          ...
          "pda": {
            "seeds": [
              ...
              {
                "kind": "account",
                "path": "global_config.current_claim_policy_version",
    ...
    {
      "name": "close_transfer_bull_proof",
      "discriminator": [
        224,
        217,
        252,
    ...
    {
      "name": "finalize_transfer_bull_proof",
      "discriminator": [
        186,
        216,
        194,
    ...
    {
      "name": "initialize_transfer_bull_proof",
      "discriminator": [
        114,
        55,
        250,
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "remove_bull_proof_buffer",
          "writable": true,
          "optional": true
        },
        {
          "name": "add_bull_proof_buffer",
          "writable": true,
          "optional": true
        },
        {
  ...
  "types": [
    {
      ...
      "type": {
        ...
        "variants": [
          ...
          {
            "name": "NativeTransferRemove"
          },
          {
            "name": "NativeTransferAdd"
          }
        ]
      }
    },
