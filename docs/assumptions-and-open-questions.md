...
14. Agave 2.1.0's SBF platform tools use Rust/Cargo 1.79. The committed lockfile therefore pins `blake3` 1.8.2, `constant_time_eq` 0.3.1, `borsh` 1.5.7, `proc-macro-crate` 3.3.0, `indexmap` 2.11.4, `solana-zk-sdk` 2.2.1, `bytemuck_derive` 1.8.1, `zeroize` 1.8.1, and `zeroize_derive` 1.4.2 instead of transitive releases that require Edition 2024.
