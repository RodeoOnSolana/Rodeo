...
export const rodeoCoreIdl = {
  ...
  "types": [
    ...
    },
    {
      "name": "IdlTypeHolder",
      "docs": [
        "Placeholder account so `OwnershipChangeReason` and `PauseFlag` are emitted",
        "into the generated IDL before they are referenced by later instructions."
      ],
      "type": {
        "kind": "struct",
        "fields": [
    ...
    },
    {
      ...
      "type": {
        ...
        "variants": [
          ...
          {
            "name": "NewRevealRequests"
          },
          {
            "name": "NewMarketplaceListings"
          },
          {
            "name": "RouterSwaps"
          }
